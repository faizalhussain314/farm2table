    ...
    <div className="w-64 bg-white  text-gray-900 dark:text-gray-100 transition-colors duration-200">
      <div className="p-4">
        ...
        <div className="space-y-6">
          <div>
            <p className="text-xs uppercase text-gray-500 dark:text-gray-400 mb-4">Overview</p>
          ...
          <div>
            <p className="text-xs uppercase text-gray-500 dark:text-gray-400 mb-4">Management</p>
            <nav className="space-y-2">
          ...
          <div>
            <p className="text-xs uppercase text-gray-500 dark:text-gray-400 mb-4">Support</p>
            <nav className="space-y-2">
